            ...
            {(activeTab === 'upload' || activeTab === 'download') && (
                ...
                >
                    ...
                    <div style={{
                        ...
                        {/* Diagram - Show architecture image for both flows */}
                        <div style={{
                            display: 'flex',
                            justifyContent: 'center',
                            alignItems: 'center'
                            ...
                            <img
                                src={activeTab === 'upload' ? '/upload-flow-architecture.png' : '/download-flow-architecture.png'}
                                alt={activeTab === 'upload' ? 'Upload Flow Architecture' : 'Download Flow Architecture'}
                                style={{
                                    maxWidth: '100%',
                                    height: 'auto',
                                    borderRadius: '12px'
